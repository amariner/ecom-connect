...
type AttentionKind = 'supplier_error' | 'partial_shipment' | 'marketplace_ack' | 'cancellation';
...
function orderCancellation(data: Detail) {
  ...
  if (order.status === 'cancelled') {
    ...
    body = '<div class="info-box">Ya hay unidades expedidas: este pedido no se puede cancelar. Correspondería gestionar una devolución, que esta demo no simula.</div>';
  } else {
